...
PATH_train = "D:/GitHub/Optics/train"
PATH_val   = "D:/GitHub/Optics/val"
...
for epoch in range(1, n_epochs+1):
    ...
    torch.save(model.state_dict(), './model/epoch{}_train_loss{:.6f}_val_loss{:.6f}_acccuracy{:.6f}.pth'.format(epoch , train_loss , valid_loss , accuracy))
...
plt.legend(loc='best')
plt.savefig('D:/GitHub/COFFEE/losses.jpg')
plt.show()